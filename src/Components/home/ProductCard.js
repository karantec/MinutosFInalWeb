                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex items-center justify-between pt-1">
                        ...
                        {!isInCart ? (
                          ...
                          <div className="flex items-center border-2 border-red-500 rounded-lg bg-red-500">
                            <button
                              onClick={(e) =>
                                handleDecreaseQuantity(product, e)
                              }
                              disabled={updatingProducts.has(product._id)}
                              className="flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7  disabled:opacity-50 disabled:cursor-not-allowed rounded-l"
                            >
                              {cartQuantity <= 1 ? (
                                <Trash2 className="w-2.5 h-2.5 sm:w-3 sm:h-3 font-bold text-white" />
                              ) : (
                                <Minus className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-white font-bold" />
                              )}
                            </button>

                            <div className="flex items-center justify-center min-w-[24px] sm:min-w-[28px] px-1 text-[10px] sm:text-xs font-bold text-white  bg-red-500 border-x border-red-300">
                            ...
                            <button
                              ...
                              disabled={updatingProducts.has(product._id)}
                              className="flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 hover:bg-red-100 disabled:opacity-50 disabled:cursor-not-allowed rounded-r"
                            >
